...
import { CustomBooleanColumn, CustomDateColumn, CustomListColumn, CustomNumberColumn, CustomStringColumn } from './CustomGriddleColumns';
import {
    CustomFilter,
    CustomNextButton,
    CustomPageDropDown,
            ...
            for (const key in this.props.columns) {
                if (this.props.data[0].hasOwnProperty(this.props.columns[key])) {
                    ...
                    switch (value.type) {
                        ...
                        case 'list':
                            columnDefinitions.push(<Griddle.ColumnDefinition key={this.props.columns[key]} id={this.props.columns[key]}
                                customComponent={CustomListColumn.bind(this)} visible={visible} />);
                            break;
                        case 'string':
                        default:
                            columnDefinitions.push(<Griddle.ColumnDefinition key={this.props.columns[key]} id={this.props.columns[key]}
